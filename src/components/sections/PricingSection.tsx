...
const PHONE_PHOTO = "/images/people/founder/softbuild/le-khai-minh.webp";
...
const TESTIMONIALS = [
  {
    ...
    quote:
      "Điều ấn tượng nhất ở SoftBuild là khả năng tư vấn. Đội ngũ chuyên gia thấu hiểu hệ thống cốt lõi của chúng tôi rất nhanh, giúp chúng tôi chọn đúng giải pháp công nghệ thay vì lãng phí ngân sách vào những tính năng không cần thiết.",
  },
  {
    name: "Trần Bảo Ngọc",
    role: "Manager",
    ...
    quote:
      "Đội ngũ SoftBuild làm việc rất chuyên nghiệp và có tư duy nhạy bén. Họ không chỉ thực hiện theo yêu cầu mà còn chủ động tư vấn những phương án thực tế để tối ưu quy trình quản lý cho chúng tôi. Kết quả bàn giao đạt chất lượng rất tốt và đáp ứng đúng mong đợi ban đầu của công ty.",
  },
  {
    name: "Lê Quang Huy",
    role: "CEO",
  ...
  },
  {
    ...
    quote:
      "Sự tận tâm và trình độ chuyên môn của các chuyên gia tại SoftBuild là điều khiến tôi ấn tượng nhất. Mọi vấn đề phát sinh trong quá trình vận hành đều được các bạn xử lý nhanh chóng và triệt để, giúp công việc của chúng tôi không bị gián đoạn. Chúng tôi rất hài lòng với sự đồng hành này.",
  },
  {
    name: "Võ Khánh Linh",
    ...
    quote:
      "Sau khi hợp tác với nhiều đơn vị, tôi nhận thấy SoftBuild có quy trình làm việc rất minh bạch và rõ ràng. Họ cung cấp những nền tảng công nghệ vững chắc và luôn sẵn sàng hỗ trợ đội ngũ của tôi làm quen với hệ thống một cách hiệu quả nhất.",
  },
  {
    name: "Đặng Quốc Bảo",
    role: "Co-founder",
    ...
    quote:
      "Lựa chọn SoftBuild làm đối tác công nghệ dài hạn là một quyết định đúng đắn của doanh nghiệp chúng tôi. Đội ngũ của họ luôn thể hiện trách nhiệm cao từ khâu lên ý tưởng đến khi vận hành thực tế. Sự chuyên nghiệp và uy tín của họ đã giúp chúng tôi giải quyết được nhiều khó khăn trong quản trị.",
  },
];
          ...
          <Reveal direction="right" className={s.contactCard}>
            <div className={s.rightTopContent}>
              <div className={s.author}>
                ...
                <img src={PHONE_PHOTO} alt="Lê Khải Minh - Co-Founder SoftBuild" className={s.authorImg} />
                <div>
              ...
              <div className={s.callSection}>
                ...
                <p className={s.contactDesc}>{tr("Hãy chia sẻ tầm nhìn của bạn, SoftBuild sẽ giúp bạn thiết kế lộ trình phát triển ứng dụng tối ưu nhất.")}</p>
              </div>
