...
const STEPS = [
  { n: "01", title: "Phân Tích & Thấu hiểu", desc: "Tiếp nhận yêu cầu và nghiên cứu sâu mô hình kinh doanh cũng như hệ thống hiện tại của bạn. Đội ngũ chuyên gia của SoftBuild sẽ bóc tách vấn đề để xác định chính xác mục tiêu cốt lõi trước khi bắt đầu." },
  ...
  { n: "05", title: "Hỗ trợ & Mở rộng", desc: "Trách nhiệm của chúng tôi không dừng lại lúc ra mắt. SoftBuild tiếp tục giám sát hệ thống 24/7, cung cấp hỗ trợ kỹ thuật ưu tiên và sẵn sàng nâng cấp, mở rộng tính năng khi doanh nghiệp tăng trưởng quy mô." },
];
...
export function ProcessTimeline() {
  ...
  return (
    <section className={styles.section}>
      <div className={styles.label}><span aria-hidden /><h2>{tr("Quy trình tư vấn tại SoftBuild")}</h2></div>
