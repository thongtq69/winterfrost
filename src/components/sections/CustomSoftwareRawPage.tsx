...
const STYLESHEETS = [
  ...
  "https://softbuildvn.vercel.app/_next/static/chunks/ca186e3335bcb97a.css",
  "https://softbuildvn.vercel.app/_next/static/chunks/539c1a0d4f1b320b.css",
];
...
const FAQ_ANSWERS: Record<string, string> = {
  ...
  "Can SoftBuild integrate custom software with our existing systems?": "Yes. API and system integration is a core component of every custom software development engagement. We connect to ERP systems, CRMs, accounting platforms, payment gateways, HR systems, warehouse management systems, and custom-built internal tools, using REST, GraphQL, or direct database connectors depending on the integration requirements.",
  ...
  "What happens after the custom software is launched?": "We offer structured post-launch support covering bug resolution, performance optimization, security patching, third-party API updates, and ongoing feature development sprints. Many clients retain SoftBuild as their long-term engineering partner — shipping new modules and enhancements on a regular sprint cadence as their business requirements evolve.",
};
