        ...
        <div className={styles.left}>
          ...
          <div className={styles.aboutBody}>
            <div className={styles.body}>
              <p>
                {tr("SoftBuild chúng tôi tạo ra các giải pháp số giúp cho các công ty phát triển và mở rộng hoạt động. Chúng tôi thường xuyên gặp gỡ với khách hàng để nắm rõ về quy trình làm việc của họ và tạo ra những sản phẩm phần mềm phù hợp với các mục tiêu thực tế. Mỗi dự án được thực hiện thông qua việc nghiên cứu cẩn thận để đảm bảo hiệu quả cho đối tác của doanh nghiệp.")}
              </p>
              <p>
                ...
                <strong>{tr("hệ thống quản lý doanh nghiệp chuyên biệt")}</strong>. {tr("Đội ngũ kỹ sư tại SoftBuild Việt Nam sử dụng các nền tảng công nghệ ổn định để đảm bảo hiệu suất tốt và dễ dàng nâng cấp trong tương lai.")}
              </p>
              <p>
                {tr("SoftBuild chú trọng đến việc tối ưu hóa giao diện và trải nghiệm người dùng nhằm nâng cao sự tương tác của người dùng. Chúng tôi đã thành công với nhiều dự án trong các lĩnh vực như tài chính, thương mại điện tử, giáo dục và vận tải. Những dự án nổi bật dưới đây thể hiện khả năng của chúng tôi trong việc cung cấp những dịch vụ chuyên nghiệp, đem đến những kết quả tốt và lợi nhuận cao cho doanh nghiệp.")}
              </p>
            </div>
          </div>
