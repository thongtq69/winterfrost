...
const ABOUT_FAQ: { q: string; a: string }[] = [
  {
    q: "Tầm nhìn và định vị thương hiệu của Winterfrost là gì?",
    a: "Winterfrost định vị là đối tác công nghệ chiến lược. Tầm nhìn của chúng tôi là kiến tạo các giải pháp số đột phá, kết hợp hoàn hảo giữa công nghệ lõi (Core Tech) và trải nghiệm người dùng (UX) để giúp doanh nghiệp tự tin dẫn đầu kỷ nguyên số.",
  },
  {
    q: "Bề dày kinh nghiệm và quy mô hoạt động của Winterfrost ra sao?",
    a: "Chúng tôi tự hào sở hữu đội ngũ chuyên gia với hơn 10 năm kinh nghiệm thực chiến. Tính đến nay, Winterfrost đã triển khai thành công các dự án công nghệ tại hơn 15 quốc gia trên toàn cầu, bao gồm các thị trường khó tính như Bắc Mỹ, Châu Âu và Châu Úc.",
  },
  {
    q: "Đối tượng khách hàng chủ yếu của Winterfrost là những ai?",
  ...
  {
    q: "Winterfrost chuyên cung cấp dịch vụ gia công hay tư vấn giải pháp?",
    a: "Chúng tôi không chỉ là đơn vị gia công phần mềm đơn thuần. Winterfrost đóng vai trò là nhà tư vấn giải pháp toàn diện: từ khâu phân tích bài toán kinh doanh, hoạch định kiến trúc hệ thống, cho đến thiết kế UI/UX và phát triển sản phẩm cuối cùng.",
  },
  {
    q: "Năng lực của đội ngũ nhân sự tại Winterfrost như thế nào?",
  ...
  {
    q: "Winterfrost có ứng dụng các công nghệ tiên tiến không?",
    a: "Chắc chắn. Bên cạnh Web và App, Winterfrost sở hữu năng lực chuyên sâu trong việc tích hợp Trí tuệ nhân tạo, phát triển nền tảng Blockchain bảo mật và kết nối vạn vật, giúp tự động hóa và khai phá tối đa tiềm năng dữ liệu của doanh nghiệp.",
  },
  {
    q: "Những con số minh chứng cho chất lượng dịch vụ của Winterfrost?",
    a: "Chất lượng dịch vụ của Winterfrost được bảo chứng bằng sự tin tưởng của hơn 250+ đối tác toàn cầu. Đặc biệt, chúng tôi luôn duy trì tỷ lệ hài lòng của khách hàng ở mức 98% – thước đo chính xác nhất cho sự tận tâm và hiệu quả dự án.",
  },
  {
    q: "Tôi ở nước ngoài thì việc hợp tác với Winterfrost sẽ diễn ra như thế nào?",
  ...
  return (
    <>
      ...
      <CTABanner
        ...
        headline={tr("Hãy trở thành đối tác cùng Winterfrost")}
